...
<html>
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-lg-1">
                <img src="http://localhost:8080/BookStore/adminPanel/Images/Page icons/Order.png" class="image" width="100%" alt="Responsive image" title="Orders" style="opacity: 0.5">
            </div>
        </div>    
        <div class="row">
