...
<html>
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-lg-1">
                <img src="http://localhost:8080/BookStore/adminPanel/Images/Page icons/Admin.png" class="image" width="100%" alt="Responsive image" title="Admins" style="opacity: 0.5">
            </div>
            <div class="col-lg-1">
